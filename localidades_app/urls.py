...
from .views import Crear, Lista, Detalles, Actualizar, Eliminar, ImprimirPDF, ImprimePDF, ExportarView, Vista_Previa, Confirmar_Importacion
from django.conf.urls.static import static

urlpatterns = [
    
    path('vista_previa/', Vista_Previa.as_view(), name='vista_previa'),
    path('confirmar_importacion/', Confirmar_Importacion.as_view(), name='confirmar_importacion'),
