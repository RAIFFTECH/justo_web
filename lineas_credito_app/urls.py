...
from .views import Crear,Lista,Detalles,Actualizar,Eliminar,ImprimirPDF,ImprimePDF,ExportarView,obtener_lin_cre,obtener_detalles_lin_cre
...
urlpatterns = [
    ...
    path('obtener_lc/<pk>',obtener_lin_cre, name='obtener_lin_cre'),

    path('obtener_det_lc/<pk>',obtener_detalles_lin_cre, name='obtener_detalles_lin_cre'),
